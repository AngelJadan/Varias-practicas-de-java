 ...
 * @author Angel
 */
public class Eparroquia extends javax.swing.JFrame {
    ...
    public Eparroquia(ControladorParroquia cparroparroquia) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ELIMINACION DE PARROQUIAS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cparroquia.buscar(Integer.parseInt(txtcodigo.getText()));
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (cparroquia.eliminar(Integer.parseInt(txtcodigo.getText()))==true) {
